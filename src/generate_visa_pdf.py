...
def get_visa_html(name: str, passport: str, purpose: str, guest_country: str,travel_from: str):
    ...
    travel_width = f"{115 - (len(travel_from) * 4.7)}px"
  ...
  <body style="font-family: 'Roboto', sans-serif;">
    <div class="main-container">
     <table class="full-width-table">
      ...
      <br> {  add_space_underlined(travel_from.upper(), travel_width)} {get_space("3px")} ( country/place of embarkation ) {get_space("5px")} for the purpose of 
...
def generate_visa_pdf(name, passport, purpose, code="unknown", guest_country="Bangladesh",travel_from="Bangladesh"):
    
    convert_html_to_pdf(
        get_visa_html(name, passport, purpose, guest_country.upper(),travel_from),
        os.path.normpath(
